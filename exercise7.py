...
def exercise7():
    ...
    for w_stretch_idx, w_stretch in enumerate(w_stretch_values):
        plt.figure(f'Heatmap: Frequency vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(frequency_values[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Frequency vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_frequency_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()

        plt.figure(f'Heatmap: Wave Frequency vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(wavefrequency_values[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Wave Frequency vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_wavefrequency_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()

        plt.figure(f'Heatmap: Forward Speed vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(forward_speed_values[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Forward Speed vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_forward_speed_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()

        plt.figure(f'Heatmap: Curvature vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(curvature_values[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Curvature vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_curvature_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()

        plt.figure(f'Heatmap: Lateral Speed vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(lateral_speed_values[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Lateral Speed vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_lateral_speed_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()

        plt.figure(f'Heatmap: Turning Radius vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(radii[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Turning Radius vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_radius_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()

        plt.figure(f'Heatmap: Total Distance Swum vs Idiff, I and w_stretch={w_stretch}')
        sns.heatmap(total_distance_values[:, :, w_stretch_idx], xticklabels=I_values, yticklabels=Idiff_values, annot=True, cmap='viridis', fmt=".2f")
        plt.xlabel('I')
        plt.ylabel('Idiff')
        plt.title(f'Heatmap: Total Distance Swum vs Idiff, I and w_stretch={w_stretch}')
        plt.savefig(f'{log_path}/heatmap_total_distance_vs_Idiff_I_w_stretch_{w_stretch}.png')
        plt.close()
